...
public class ProcessTransactions
{
	...
	do {
		...
		System.out.println(Account.getTotalDepositAmount());
		//Print total amount of withdrawals
		System.out.println(Account.getTotalWithdrawalAmount());
		Account.resetNumDeposits();
		Account.resetTotalDepositAmount();
		Account.resetNumWithdrawals();
		Account.resetTotalWithdrawalAmount();
		day++;
		System.out.print("\nNext day? (y/n)");
