...
public class Staff
{
   ...
   public Staff ()
   {
      ...
      staffList[6] = new Commision ("Steve", "267 Sixth St.", "555-0862", "256-72-5123", 6.25, 0.2);
      staffList[7] = new Commision ("Bob", "894 Seventh Ave.", "555-0153", "237-52-6812", 9.75, 0.15);
